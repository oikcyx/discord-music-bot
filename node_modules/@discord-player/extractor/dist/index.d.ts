import { BaseExtractor, SearchQueryType, Track, GuildQueueHistory, ExtractorInfo, ExtractorSearchContext, ExtractorExecutionContext } from 'discord-player';
import * as soundcloud_ts from 'soundcloud.ts';
...
declare class SoundCloudExtractor extends BaseExtractor<SoundCloudExtractorInit> {
    ...
    internal: soundcloud_ts.default;
...
type StreamFN = (q: string, ext: BaseExtractor) => Promise<stream.Readable | string>;
...
declare function makeSCSearch(query: string): Promise<soundcloud_ts.SoundcloudTrackV2[]>;
declare function pullYTMetadata(ext: BaseExtractor, info: Track): Promise<youtube_sr.Video | null>;
declare function pullSCMetadata(ext: BaseExtractor, info: Track): Promise<soundcloud_ts.SoundcloudTrackV2 | null>;
...
export { AppleMusicExtractor, AppleMusicExtractorInit, AttachmentExtractor, BridgeProvider, BridgeSource, IBridgeSource, index as Internal, LyricsData, ReverbnationExtractor, SoundCloudExtractor, SoundCloudExtractorInit, SpotifyExtractor, SpotifyExtractorInit, StreamFN, UA, VimeoExtractor, YoutubeExtractor as YouTubeExtractor, YouTubeLibs, YoutubeExtractor, YoutubeExtractorInit, createBridgeProvider, createImport, defaultBridgeProvider, fetch, loadYtdl, lyricsExtractor, makeSCSearch, makeYTSearch, pullSCMetadata, pullYTMetadata, version };
